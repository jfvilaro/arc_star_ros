 #include "acd/arc_star_detector15.h"
...
bool ArcStarDetector::isCorner(double et, int ex, int ey, bool ep) {
    ...
    const int kSmallCircleSize = 32;
    const int kLargeCircleSize = 40;
    const int kSmallMinThresh = 6;
    const int kSmallMaxThresh = 12;
    const int kLargeMinThresh = 7;
    const int kLargeMaxThresh = 14;
